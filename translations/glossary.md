...
| Thuật ngữ | Cách dịch/ghi chú |
|---|---|
| Cosmetic products | Sản phẩm mỹ phẩm |
| Formulation | Formulation; có thể dịch là thiết kế công thức/công thức khi ngữ cảnh cần tự nhiên hơn |
| Insight | Insight; hiểu biết sâu về người tiêu dùng khi cần giải thích |
| Claim | Claim; tuyên bố/khẳng định sản phẩm khi cần diễn giải |
| Verbatim | Verbatim; phát ngôn/trích dẫn nguyên văn từ người tiêu dùng khi cần diễn giải |
| Colour psychology | Tâm lý học màu sắc |
| Chromatic accord | Accord màu sắc; tổ hợp/phối hợp màu sắc khi cần diễn giải |
| Sensory | Cảm quan; thuộc về giác quan |
| Eye-tracking | Eye-tracking; theo dõi mắt khi cần diễn giải |
| EEG | EEG; điện não đồ khi cần diễn giải |
| fMRI | fMRI; chụp cộng hưởng từ chức năng |
| Saccade | Saccade; chuyển động mắt nhanh giữa các điểm cố định thị giác |
| Electrodermal activity | Hoạt động điện da |
| Heat map | Heat map; bản đồ nhiệt khi cần diễn giải |
| Soft-focus | Soft-focus; hiệu ứng làm mờ quang học/nếp nhăn khi cần diễn giải |
| Explicit evaluation | Đánh giá hiển hiện |
| Implicit evaluation | Đánh giá ngầm định |
| Concept | Concept; ý tưởng/khái niệm sản phẩm khi cần diễn giải |
| Packaging | Bao bì |
| Sensory additivity | Tính cộng hưởng cảm quan |
| Sensory suppression | Sự ức chế cảm quan |
| Multisensory process | Quá trình đa cảm quan |
| Olfactory note | Nốt hương |
...
| Skin morphology | Hình thái học của da |
| Stratum corneum | Lớp sừng |
| Epidermis | Biểu bì |
| Dermis | Trung bì |
| Subcutis | Mô dưới da |
| Skin appendages | Các phần phụ của da |
| Epidermal differentiation | Biệt hóa biểu bì |
| Cornified cell envelope | Bao tế bào sừng hóa |
| Desquamation | Bong vảy |
| Viable epidermis | Biểu bì sống |
...
| Nociceptor | Thụ thể cảm nhận đau |
| Meissner’s corpuscle | Tiểu thể Meissner |
| Gross structure | Cấu trúc đại thể |
| Inflammatory mediator | Chất trung gian gây viêm |
| Vasodilation | Giãn mạch |
| Perspiration | Tiết mồ hôi |
| Stratum basale | Lớp đáy |
| Stratum spinosum | Lớp gai |
| Stratum granulosum | Lớp hạt |
| Stratum lucidum | Lớp trong |
| Keratin | Keratin |
| Intercellular lipid lamellae | Các phiến lipid gian bào |
| Melanocyte | Tế bào hắc tố |
| Merkel cell | Tế bào Merkel |
| Corneocyte | Tế bào sừng |
| Desmosome | Desmosome; thể liên kết khi cần diễn giải |
| Skin turnover | Sự thay mới da |
| Insensible perspiration | Thoát hơi nước không nhận biết được |
| Basal lamina | Lá đáy |
| Basement membrane | Màng đáy |
| Lamina densa | Lá đặc |
| Lamina lucida | Lá sáng |
| Hemidesmosome | Hemidesmosome; bán thể liên kết khi cần diễn giải |
| Keratin intermediate filament | Sợi trung gian keratin |
| Anchoring fibril | Sợi neo |
| Adherens junction | Mối nối bám dính |
| Dendritic cell | Tế bào tua |
| Langerhans cell | Tế bào Langerhans |
| Antigen-presenting cell | Tế bào trình diện kháng nguyên |
| Contact sensitisation | Mẫn cảm tiếp xúc |
| Melanin | Melanin |
| Melanosome | Melanosome |
| Melanogenesis | Quá trình sinh melanin |
| Eumelanin | Eumelanin; sắc tố melanin nâu/đen |
| Pheomelanin | Pheomelanin; sắc tố melanin vàng/đỏ |
| Papillary layer | Lớp nhú |
| Fibroblast | Nguyên bào sợi |
| Mast cell | Dưỡng bào |
| Telocyte | Telocyte |
| Pacinian corpuscle | Tiểu thể Pacini |
| Mechanoreceptor | Thụ thể cơ học |
| Arteriovenous anastomosis | Cầu nối động–tĩnh mạch |
| Interstitial pressure | Áp lực dịch kẽ |
| Lymphatic flow | Lưu lượng bạch huyết |
| Hypodermis | Hạ bì; mô dưới da |
| Adipocyte | Tế bào mỡ |
...
| Urokinase-type plasminogen activator (uPA) | Chất hoạt hóa plasminogen kiểu urokinase (uPA) |
| Serine protease | Protease serine |
| Transglutaminase | Transglutaminase |
| Tonofilament | Tơ trương lực |
| Membrane-coating granule | Hạt phủ màng |
| Keratohyalin granule | Hạt keratohyalin |
| Lamellar granule | Hạt dạng phiến |
| Stratum corneum chymotryptic enzyme (SCCE) | Enzyme chymotrypsin của lớp sừng (SCCE) |
| Epidermal permeability barrier | Hàng rào thấm của biểu bì |
| Filaggrin | Filaggrin |
| Tight junction | Mối nối chặt |
| Protein envelope | Bao protein |
| Lipid envelope | Bao lipid |
| Cross-linking | Liên kết chéo |
| Sulfhydryl oxidase | Sulfhydryl oxidase |
| Disulfide bond | Liên kết disulfide |
| Isopeptide bond | Liên kết isopeptide |
| Loricrin | Loricrin |
| Involucrin | Involucrin |
| ω-Hydroxyceramide | ω-Hydroxyceramide |
| Nail matrix | Mầm móng |
| Profilaggrin | Profilaggrin; tiền chất của filaggrin |
| Dephosphorylation | Khử phosphoryl |
| Proteolysis | Phân giải protein |
| Atopic dermatitis | Viêm da cơ địa |
| Corneodesmosome | Corneodesmosome; thể liên kết tế bào sừng khi cần diễn giải |
| Corneodesmosin | Corneodesmosin |
| X-linked ichthyosis | Bệnh vảy cá liên kết nhiễm sắc thể X |
